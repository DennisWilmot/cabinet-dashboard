...
export default function ActionsPage() {
  ...
  return (
    <>
      <DashboardShell breadcrumbs={[{ label: 'Actions' }]}>
        <div className="animate-fade-up">
          ...
          <div className="flex flex-col sm:flex-row gap-[var(--space-md)] mb-[var(--space-xl)] sm:mb-[var(--space-2xl)]">
            ...
            <select
              ...
              className="px-3 py-2 bg-surface border border-border-default rounded-lg text-[length:var(--text-caption)] text-text-primary cursor-pointer focus:outline-none focus:border-gold/60 focus:ring-1 focus:ring-gold/30"
            >
      ...
      <div className="flex flex-col sm:flex-row sm:items-start gap-[var(--space-sm)] sm:gap-[var(--space-lg)]">
        ...
        <div className="flex-1 min-w-0">
          ...
          <button
            ...
            className="mt-[var(--space-sm)] inline-flex items-center gap-1 text-[length:var(--text-caption)] text-text-secondary hover:text-text-primary transition-colors cursor-pointer focus-visible:ring-2 focus-visible:ring-gold/50 focus-visible:outline-none rounded"
          >
            ...
            <div className="mt-[var(--space-md)] border-t border-border-default pt-[var(--space-md)]">
              ...
              <div className="flex gap-[var(--space-sm)]">
                <input
                  ...
                  aria-label="Status update comment"
                  className="flex-1 px-3 py-2 bg-page border border-border-default rounded-lg text-[length:var(--text-caption)] placeholder:text-text-secondary/50 focus:outline-none focus:border-gold/60 focus:ring-1 focus:ring-gold/30"
                />
                <button
                  onClick={addComment}
                  disabled={!draft.trim()}
