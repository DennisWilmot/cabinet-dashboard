    ...
    <>
      ...
      <DashboardShell>
        <div className="animate-fade-up">
          <header className="mb-[var(--space-3xl)]">
            ...
            >
              <div className="flex items-start gap-[var(--space-lg)]">
                <Image
                  ...
                  width={64}
                  height={64}
                  className="rounded-full bg-border-default flex-shrink-0 mt-1 object-cover"
                />
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-[var(--space-base)]">
                    <div>
                      <h2 className="text-[length:var(--text-h1)] font-bold text-text-primary group-hover:text-gold-dark transition-colors">
                        {overview.name}
                      </h2>
                      <p className="text-[length:var(--text-body)] text-text-secondary mt-[2px]">
                  ...
                  <div className="grid grid-cols-3 gap-[var(--space-xl)] mt-[var(--space-lg)]">
                    <div>
                      <p className="text-[length:var(--text-caption)] text-text-secondary">Allocation</p>
                      <p className="text-[length:var(--text-h2)] font-bold mt-[2px]">{formatCurrency(overview.totalAllocation)}</p>
                    </div>
                    <div>
                      <p className="text-[length:var(--text-caption)] text-text-secondary">Spent to Date</p>
                      <p className="text-[length:var(--text-h2)] font-bold mt-[2px]">
          ...
          {!mockDataEnabled && (
            <div className="mt-[var(--space-2xl)] py-[var(--space-base)] px-[var(--space-lg)] border border-gold/30 bg-gold-light/30 rounded-sm max-w-2xl">
          ...
          <div className="mt-[var(--space-4xl)] pt-[var(--space-xl)] border-t border-border-default animate-fade-up stagger-3">
            <div className="flex items-center gap-[var(--space-md)] text-text-secondary">
              <div className="flex -space-x-1.5">
                {[1, 2, 3, 4, 5].map(i => (
                  <div key={i} className="w-7 h-7 rounded-full bg-border-default border-2 border-page" />
                ))}
              </div>
              <p className="text-[length:var(--text-body)]">
                <span className="font-semibold text-text-primary">15 more ministries</span>{' '}
                coming soon — Education, Health, National Security, and others.
              </p>
            </div>
          </div>
        </div>
